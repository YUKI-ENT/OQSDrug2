...
& $compiler /nologo /target:exe /platform:x86 /r:System.Windows.Forms.dll /r:System.Drawing.dll "/r:$dataReference" "/out:$output/DynamicsComSmokeTests.exe" "$PSScriptRoot/DynamicsComSmokeTests.cs"
